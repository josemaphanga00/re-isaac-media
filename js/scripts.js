...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const weddingOptions = document.getElementById("wedding_options");
  const eventOptions = document.getElementById("event_options");
  const hoursField = document.getElementById("hours_field");
  ...
  const eventPackage = document.getElementById("event_package");

  eventPackage.addEventListener("change", function () {
